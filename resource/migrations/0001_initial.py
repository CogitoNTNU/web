    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_creator', models.CharField(max_length=150)),
                ('creation_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('added_by_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='created_resources', to=settings.AUTH_USER_MODEL)),
                ('starred_by', models.ManyToManyField(blank=True, related_name='starred_resources', to=settings.AUTH_USER_MODEL)),
            ],
            options={
